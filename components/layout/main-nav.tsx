        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <div className="flex items-center space-x-6">
              <a href="#" className="text-white hover:text-white/80 transition-colors">Deals</a>
              <a href="#" className="text-white hover:text-white/80 transition-colors">Support</a>
              <a href="#" className="text-white hover:text-white/80 transition-colors">Partnership</a>
              <a href="#" className="text-white hover:text-white/80 transition-colors">Bookings</a>
            </div>
        ...
        >
          <div className="bg-white/95 backdrop-blur-sm shadow-lg rounded-b-lg p-4 space-y-4">
            <div className="flex flex-col space-y-3">
              <a href="#" className="text-gray-800 hover:text-black py-2 px-4 rounded-lg hover:bg-gray-100 transition-colors">
                Deals
              </a>
              <a href="#" className="text-gray-800 hover:text-black py-2 px-4 rounded-lg hover:bg-gray-100 transition-colors">
                Support
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <div className="space-y-2">
                <Button variant="ghost" className="w-full justify-start text-gray-800 hover:text-black hover:bg-gray-100">
                  Login
                </Button>
